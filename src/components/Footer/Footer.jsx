  ...
  return (
    <footer className="p-10 footer bg-base-200 text-base-content">
      ...
      <nav>
        ...
        <button
          onClick={() => openModal("quienes_somos_modal")}
          className="link link-hover"
        >
          ¿Quiénes Somos?
        </button>
        <button
          onClick={() => openModal("mision_modal")}
          className="link link-hover"
        >
          Nuestra Misión
        </button>
        <button
          onClick={() => openModal("vision_modal")}
          className="link link-hover"
        >
          Nuestra Visión
        </button>
        <button
          onClick={() => openModal("contactanos_modal")}
          className="link link-hover"
        >
          Contáctanos
        </button>
      ...
      <nav>
        ...
        <button
          onClick={() => openModal("terms_use_modal")}
          className="link link-hover"
        >
          Términos de uso
        </button>
        <button
          onClick={() => openModal("privacy_policy_modal")}
          className="link link-hover"
        >
          Política de privacidad
        </button>
        <button
          onClick={() => openModal("cookies_policy_modal")}
          className="link link-hover"
        >
          Política de Cookies
        </button>
